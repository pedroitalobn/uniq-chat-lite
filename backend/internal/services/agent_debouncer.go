...
// String vazia é tratada como "smart" (default) — assim agentes
// pre-existentes pegam o comportamento humano sem precisar de
// migration, e quem realmente quer responder na hora marca "off"
// explicitamente.
