...
export const instancesApi = {
  ...
  safety: (id: string) => api.get(`/v1/instances/${id}/safety`),
  resumeSafety: (id: string) => api.post(`/v1/instances/${id}/safety/resume`),
  reviewSafety: (id: string) => api.post(`/v1/instances/${id}/safety/review`),
...
export const workspacesApi = {
  ...
  myPendingInvites: () => api.get(`/v1/workspaces/my-invites`),
};
...
export const adminApi = {
  ...
  testPaymentProvider: (provider: "stripe" | "asaas" | "abacatepay") =>
