...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/v1/{server}/{instance}/messages/buttons", description: "Enviar mensagem com botões de resposta rápida", auth: "token", body: { to: "5511999999999@s.whatsapp.net", text: "Escolha:", buttons: [{ id: "1", text: "Sim" }, { id: "2", text: "Não" }] } },
      { method: "POST", path: "/v1/{server}/{instance}/messages/list", description: "Enviar mensagem com lista de opções", auth: "token", body: { to: "5511999999999@s.whatsapp.net", title: "Menu", sections: [{ title: "Seção 1", rows: [{ id: "1", title: "Opção 1" }] }] } },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/instances/{id}/webhooks", description: "Criar novo webhook", auth: "bearer", body: { url: "https://seu-servidor.com/webhook", events: ["message.received", "connection.update"] }, response: `{ "id": "...", "url": "...", "secret": "..." }` },
