...
import {
  Bot, Brain, ChevronLeft, Globe, Link2, Mic2, Plus,
  Save, Shield, Sparkles, Trash2, Upload, Wand2,
} from "lucide-react";
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <Link href="/agents" className="inline-flex items-center gap-2 text-sm mb-2" style={{ color: "var(--text-3)" }}>
            <ChevronLeft className="w-4 h-4" />
            Voltar para agentes
          </Link>
          <h1 className="text-2xl font-semibold flex items-center gap-3" style={{ color: "var(--text-1)" }}>
            <Wand2 className="w-6 h-6" style={{ color: "var(--green)" }} />
            Personality Builder
          </h1>
          <p className="text-sm mt-1" style={{ color: "var(--text-3)" }}>
            Configure identidade, RAG, skills, apps e a LLM de cada instância em um só lugar.
          </p>
        </div>
