              ...
              <div key={i} className="animate-pulse px-5 py-4 flex items-center gap-4">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="h-3 rounded-full w-36" style={{ background: "var(--surface-2)" }} />
                    <div className="h-5 rounded-full w-20" style={{ background: "var(--surface-3)" }} />
                  </div>
                  <div className="flex gap-3">
                    <div className="h-2 rounded-full w-16" style={{ background: "var(--surface-3)" }} />
                    <div className="h-2 rounded-full w-24" style={{ background: "var(--surface-3)" }} />
                  </div>
                </div>
                <div className="w-5 h-5 rounded-full flex-shrink-0" style={{ background: "var(--surface-3)" }} />
              </div>
            ))}
          </div>
        ) : workspaces.length === 0 ? (
